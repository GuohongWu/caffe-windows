...
namespace caffe {
	...
	// Based on sigmoid_cross_entropy_loss_layer.
	// When positive and negative categorys are too unbalance, we need to add 'weight' param.
	// 'weight' is determined by the ratio of the numbers of positive and
